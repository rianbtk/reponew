...
def percobaan4():
    ...
    def test_var_nama():
        try:
            codewars_test.assert_equals("Joko ", pc.nama,
                                        'Error : Jawaban yang benar, variabel nama adalah string "Joko " (Terdapat spasi sesudah Joko)')
    ...
    def test_var_lengkap():
        try:
            codewars_test.assert_equals("Widodo", pc.lengkap,
                                        'Error : Jawaban yang benar, variabel lengkap adalah string "Widodo"')
        except AttributeError as e:
            print(e)
